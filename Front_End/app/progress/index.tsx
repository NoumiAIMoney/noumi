...
import Image1 from '/Users/kyranalmeida/noumi-app/assets/home.svg'; 
import Image2 from '/Users/kyranalmeida/noumi-app/assets/goals.svg'; 
import Image3 from '/Users/kyranalmeida/noumi-app/assets/progress.svg';
    ...
    <View style={styles.content}>
      ...
      <View style={styles.recapsList}>
        {[
          ...
          <TouchableOpacity key={index} style={styles.recapCard}>
